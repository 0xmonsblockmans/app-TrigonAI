...
import { useTrigonAIRouter, useLimitOrderManager } from './useContract'
    ...
    case 'STF':
      return (
        <Trans>
          ...
          transfer and rebase tokens are incompatible with TrigonAI.
        </Trans>
      )
    case 'TF':
      return (
        <Trans>
          ...
          rebase tokens are incompatible with TrigonAI.
        </Trans>
      )
    default:
      if (reason?.indexOf('undefined is not an object') !== -1) {
        ...
        return (
          <Trans>
            ...
            and rebase tokens are incompatible with TrigonAI.
          </Trans>
        )
      }
      return (
