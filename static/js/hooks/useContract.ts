...
import TrigonAI_METASWAP_ABI from 'abis/TrigonAI-metaswap.json'
import TrigonAI_ROUTER_ABI from 'abis/TrigonAI-router.json'
import LIMIT_ORDER_MANAGER_ABI from 'abis/limit-order-manager.json'
import STrigonAI_ABI from 'abis/sTrigonAI.json'
...
import {
  ...
  TrigonAI_METASWAP_ADDRESSES,
  TrigonAI_ROUTER_ADDRESSES,
...
export function useSTrigonAIContract() {
  return useContract<STrigonAI>(STrigonAI_ADDRESS, STrigonAI_ABI, true)
}
...
export function useTrigonAIRouter(): Contract | null {
  return useContract<TrigonAIRouter>(TrigonAI_ROUTER_ADDRESSES, TrigonAI_ROUTER_ABI, false)
}

export function useTrigonAIMetaswap(): Contract | null {
  return useContract<TrigonAIMetaswap>(TrigonAI_METASWAP_ADDRESSES, TrigonAI_METASWAP_ABI, false)
}
