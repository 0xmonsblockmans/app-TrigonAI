...
export const routingApiTrigonAI = createApi({
  reducerPath: 'routingApiTrigonAI',
...
export const { useGetQuoteQuery } = routingApiTrigonAI
export const { useGetGaslessQuoteQuery } = routingApiTrigonAI
