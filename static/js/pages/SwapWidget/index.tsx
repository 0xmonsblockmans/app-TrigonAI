...
import TrigonLogo from './../../assets/images/Trigon_Transparent_1.png'
            ...
            <AppBody>
              <WidgetHeader>
                <PoweredBy>
                  ...
                  <ExternalLink href="https://app.TrigonAI.finance" style={{ fontSize: '14px' }}>
                    <img src={TrigonLogo} alt="Trigon Logo" height="24px" />
                  </ExternalLink>
                </PoweredBy>
                          ...
                          <AutoRow justify="space-between" style={{ flexWrap: 'nowrap' }}>
                            <span style={{ display: 'flex', alignItems: 'center', whiteSpace: 'break-spaces' }}>
                              ...
                              signatureState === UseERC20PermitState.SIGNED ? (
                                ...
                                <Trans>Allow TrigonAI to use your {currencies[Field.INPUT]?.symbol}</Trans>
                              )}
                            </span>
                            {approvalState === ApprovalState.PENDING ? (
                              <Loader stroke="white" />
                  ...
                  {account ? (
                    ...
                    <Trans>
                      <NoWalletStyle>
                        ...
                        <a href="https://docs.TrigonAI.finance" target="_blank" rel="noreferrer">
                          Read More
                        </a>
                      </NoWalletStyle>
                    </Trans>
