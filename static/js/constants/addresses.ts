...
export const STrigonAI_ADDRESS: AddressMap = {
...
export const Trigon_TOKEN_ADDRESSES: AddressMap = {
  ...
  [SupportedChainId.MAINNET]: '0x601995C919310f03c75d1db730775F18b15Fa717',
  [SupportedChainId.POLYGON]: '0x14Af1F2f02DCcB1e43402339099A05a5E363b83c',
  [SupportedChainId.BASE]: '0x14Af1F2f02DCcB1e43402339099A05a5E363b83c', // todo*: update when Trigon is deployed on base
}
export const UNISWAP_UTILS_ADDRESSES: AddressMap = {
  [SupportedChainId.KOVAN]: '0x9E1E4f041877f1aB604E5B109Cf699545e20E4bC',
}
export const TrigonAI_ROUTER_ADDRESSES: AddressMap = {
...
export const TrigonAI_METASWAP_ADDRESSES: AddressMap = {
