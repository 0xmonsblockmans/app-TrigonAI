...
import { Trigon_TOKEN_ADDRESSES, UNI_ADDRESS } from './addresses'
...
export const Trigon: { [chainId: number]: Token } = {
  [SupportedChainId.KOVAN]: new Token(
    SupportedChainId.KOVAN,
    Trigon_TOKEN_ADDRESSES[SupportedChainId.KOVAN],
    18,
    'Trigon',
    'TrigonAI'
  ),
  [SupportedChainId.OPTIMISTIC_KOVAN]: new Token(
    ...
    Trigon_TOKEN_ADDRESSES[SupportedChainId.OPTIMISTIC_KOVAN],
    18,
    'Trigon',
    'TrigonAI'
  ),
  [SupportedChainId.OPTIMISM]: new Token(
    SupportedChainId.OPTIMISM,
    Trigon_TOKEN_ADDRESSES[SupportedChainId.OPTIMISM],
    18,
    'Trigon',
    'TrigonAI'
  ),
  [SupportedChainId.ARBITRUM_RINKEBY]: new Token(
    ...
    Trigon_TOKEN_ADDRESSES[SupportedChainId.ARBITRUM_RINKEBY],
    18,
    'Trigon',
    'TrigonAI'
  ),
  [SupportedChainId.ARBITRUM_ONE]: new Token(
    SupportedChainId.ARBITRUM_ONE,
    Trigon_TOKEN_ADDRESSES[SupportedChainId.ARBITRUM_ONE],
    18,
    'Trigon',
    'TrigonAI'
  ),
  [SupportedChainId.MAINNET]: new Token(
    SupportedChainId.MAINNET,
    Trigon_TOKEN_ADDRESSES[SupportedChainId.MAINNET],
    18,
    'Trigon',
    'TrigonAI'
  ),
  [SupportedChainId.POLYGON]: new Token(
    SupportedChainId.POLYGON,
    Trigon_TOKEN_ADDRESSES[SupportedChainId.POLYGON],
    18,
    'Trigon',
    'TrigonAI'
  ),
  [SupportedChainId.BASE]: new Token( // todo*: edit this when Trigon is deployed on BASE
    SupportedChainId.BASE,
    Trigon_TOKEN_ADDRESSES[SupportedChainId.BASE],
    18,
    'Trigon',
    'TrigonAI'
  ),
