...
export default function PerpModal({ isOpen, onDismiss }: { isOpen: boolean; onDismiss: () => void }) {
  ...
  const perpRedirectionHandler = () => {
    if (checked) localStorage.setItem('TrigonTOUTicked', Date.now().toString())
    onDismiss()
    window.open('https://perp.TrigonAI.finance/', '_blank')
  }
        ...
        <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
          <PerpText>
            ...
            <Trans>
              ...
              <ExternalLink href="https://TrigonAI.finance/terms-of-use" target="_blank">
