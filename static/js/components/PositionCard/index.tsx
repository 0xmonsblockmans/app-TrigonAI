...
import { Trigon } from 'constants/tokens'
...
export default function FullPositionCard({ fundingBalance, minBalance }: FundingCardProps) {
  ...
  const usdcPrice = useUSDCPrice(TrigonToken ?? undefined)?.toSignificant(4)
  ...
  return (
    <AccountStatusWrapper gap="10px">
            ...
            <FixedHeightRow>
              ...
              <RowFixed>
                <MouseoverTooltip
                  text={
                    <Trans>
                      Please deposit $Trigon to process your limit order.
                      <br />
                      <br />
            ...
            <RowFixed>
              {isUnderfunded ? (
                <AutoColumn>
                  <RowFixed gap="1rem">
                    <TYPE.error error>
                      <Trans>Trigon deposit required</Trans>
                    </TYPE.error>
                  </RowFixed>
                </AutoColumn>
              ) : (
            ...
            <FixedHeightRow>
              ...
              <RowFixed>
                <MouseoverTooltip
                  text={
                    <Trans>
                      You will need to maintain a minimum Trigon balance to cover for the service fees.
                      <br />
                      <br />
                      Recommendation is to deposit at least twice the minimum balance.
                    </Trans>
      ...
      <ButtonGroup>
        <StyledButtonSecondary as={Link} to={`/balance/deposit/${TrigonToken?.address}`}>
          <Text fontSize={16} fontWeight={600}>
            <Trans>Deposit Trigon</Trans>
          </Text>
        </StyledButtonSecondary>
        <StyledButtonSecondary as={Link} to={`/balance/withdraw/${TrigonToken?.address}`}>
          <Text fontSize={16} fontWeight={600}>
...
export function StakePositionCard({ fundingBalance, minBalance, gasPrice }: FundingCardProps) {
  ...
  let result = useSingleCallResult(stakeManager, 'getEarnedSTrigon', [account?.toString()])
            ...
            <AutoColumn gap="8px">
              <FixedHeightRow>
                ...
                {stakedBalance != null ? (
                  <RowFixed>
                    <Text fontSize={16} fontWeight={400} marginLeft={'6px'}>
                      <TYPE.body>{stakedBalance} Trigon</TYPE.body>
                    </Text>
                  </RowFixed>
                ) : (
                  '-'
              ...
              <FixedHeightRow>
                ...
                {earnedBalance ? (
                  <RowFixed>
                    <Text fontSize={16} fontWeight={400} marginLeft={'6px'}>
                      <TYPE.body>{earnedBalance} Trigon </TYPE.body>
                    </Text>
                  </RowFixed>
                ) : (
                  '-'
              ...
              <FixedHeightRow>
                ...
                {totalValueLocked != null ? (
                  <RowFixed>
                    <Text fontSize={16} fontWeight={400} marginLeft={'6px'}>
                      <TYPE.body>{totalValueLocked} Trigon</TYPE.body>
                    </Text>
                  </RowFixed>
                ) : (
                  '-'
