...
import tokenLogo from '../../assets/images/Trigon_logo.png'
import TrigonAILogo from '../../assets/images/Trigon_Transparent_1.png'
...
export default function Header() {
  ...
  const TrigonPrice = useUSDCPrice(TrigonToken)
  ...
  const pools: { [chainId: number]: string } = {
    ...
    [SupportedChainId.BASE]: 'https://info.uniswap.org/#/pools/0x6ae0cdc5d2b89a8dcb99ad6b3435b3e7f7290077', // todo*: add Trigon pool on base when deployed
  }
    ...
    <>
      <HeaderFrame showBackground={true}>
        ...
        <Title href=".">
          <UniIcon>
            <MainLogo>
              <img src={TrigonAILogo} alt={'TrigonAI logo'} />
            </MainLogo>
            <PhoneLogo>
              ...
              <ExternalLink href={pools[chainId]} style={{ textDecoration: 'none' }}>
                {TrigonPrice ? (
                  <TokenPrice>
                    ...
                    <TYPE.body fontSize={16}>${TrigonPrice?.toSignificant(2)}</TYPE.body>
                  </TokenPrice>
                ) : null}
              </ExternalLink>
            )}
